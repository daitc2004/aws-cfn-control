...
def main():
    ...
    AmiId = t.add_parameter(Parameter(
        'AmiId',
        Type="String",
        Description="Valid AMI in the current region (ami-xxxxxxxx)",
        Default="ami-ca10a1b5",
    ...
    ASG01_PG = t.add_resource(AutoScalingGroup(
        ...
        MinSize=Ref(ASG01ClusterSize),
        MaxSize=Ref(ASG01ClusterSize),
        Cooldown=10,
    ...
    ASG02_PG = t.add_resource(AutoScalingGroup(
        ...
        MinSize=Ref(ASG02ClusterSize),
        MaxSize=Ref(ASG02ClusterSize),
        Cooldown=10,
